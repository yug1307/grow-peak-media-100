  ...
  return ( 
    <div> 
      <Topbar /> 
        ...
        <div class="space-y-2 text-gray-800 sm:text-lg">
          <p class="font-semibold text-xl">We Help Your Brand Grow Through Powerful Content</p>
          <p class="pb-3">At GrowPeak Media, we create videos and social media content that help brands stand out, connect with their audience, and grow faster.
