...
const contact = [
  { icon: <MapPin/>, address: "Nandanvan, Nagpur - 440 024" },
  ...
  return(
    ...
    <footer className="bg-gray-900 text-gray-300 py-10">
      <section className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-8 space-y-6">
        {/* Logo */}
        <svg width="700" height="100%" viewBox="0 0 1200 180" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="170" y1="55" x2="530" y2="55" className="divider"/>
