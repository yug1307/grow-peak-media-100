  ...
  return ( 
    <div className="w-full bg-gray-800 text-white">
      <div className="container mx-auto flex items-center justify-between px-4 py-2">
        ...
        {/* Menu Items */}
        <ul className={`flex-col md:flex-row md:flex md:items-start md:justify-between md:space-x-8 space-y-2 md:space-y-0 absolute md:static right-0 top-12 bg-gray-800 md:bg-transparent w-full md:w-auto z-50 transition-all duration-300 ${isOpen ? 'flex' : 'hidden'}`}>
